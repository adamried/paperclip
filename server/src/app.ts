...
import { forkUpdateRoutes } from "./routes/fork-update.js";
import { runtimeInventoryRoutes } from "./routes/runtimes.js";
...
export async function createApp(
  ...
  api.use(forkUpdateRoutes());
  api.use(runtimeInventoryRoutes());
