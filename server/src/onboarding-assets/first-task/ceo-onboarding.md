...
- Ask only about material ambiguity that prevents useful work. Accept responsibilities in the Board's own words; do not demand an artificial job category from them.
