...
- Ask the Chief of Staff to hire when the team needs a new seat. Use the `paperclip-create-agent` skill yourself only when there is no Chief of Staff.
...
- Hiring: Decide when capacity is needed; the Chief of Staff runs the hire.
